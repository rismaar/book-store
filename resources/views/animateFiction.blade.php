...
<h1 class="text-center mb-3">Animasi Fiksi</h1>
                    ...
                    <div class="modal-body">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p>Karya {{ $book->author }}</p>
                                <p><b>Format: </b>Soft Cover ver</p>
                                <p>Penerbit: {{ $book->supplier->nama_perusahaan }}</p>
                        ...
                        <p>Tanggal terbit: {{ \Carbon\Carbon::parse($book->publish_date)->translatedFormat('d F Y') ?? '-' }}</p>
                    </div>
                </div>
            </div>
        </div>
